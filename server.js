...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    h1 { font-size: 26px; font-style: italic; color: #2b2e27; margin-bottom: 14px; }
    p { font-family: system-ui, sans-serif; font-size: 14px; color: #6f7566; line-height: 1.65; margin-bottom: 28px; }
    p strong { color: #5f6452; }
    .badge {
      display: inline-flex; align-items: center; gap: 8px;
      border: 1px solid #e0dbd0; background: white; border-radius: 999px;
      padding: 8px 16px; font-family: system-ui, sans-serif;
      font-size: 12px; color: #8a8f7d; margin-bottom: 32px;
    }
    .footer { font-family: system-ui, sans-serif; font-size: 10px; letter-spacing: 0.15em; color: #b0b5a5; text-transform: uppercase; }
  </style>
</head>
<body>
  <div class="card">
    ...
    <p>Ce lien n'est pas valide ou a expiré.<br/><br/>
      Veuillez contacter <strong>Patrice DIAKITÉ</strong><br/>pour obtenir votre accès personnalisé.</p>
    <div class="badge">
